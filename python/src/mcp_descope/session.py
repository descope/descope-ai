...
def require_scopes(
    ...
    Example:
        ```python
        from mcp_descope import DescopeMCP, validate_token, require_scopes
...
def validate_token_require_scopes_and_get_user_id(
    ...
    Example:
        ```python
        from mcp_descope import validate_token_require_scopes_and_get_user_id, InsufficientScopeError
    ...
    # Extract user ID
    user_id = token_result.get('sub') or token_result.get('userId') or token_result.get('user_id')
